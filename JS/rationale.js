(function () {
    ...
    d3.csv('csv/vic_rationale.csv', function (d) {
        ...
        var nest = d3.nest()
            ...
            .rollup(function (leaves) {
                return {
                    // easier to plot the total without accessing underlying layers
    ...
    var barChart = function (nest) {
        ...
        // each bar in a different group, easier to add labels later
        var groups = svg
            .selectAll('.group')
            .data(nest, function (d) {
                return d.key + d.total // unique key
            });
    ...
    /*     var stackedBar = function (data, key) {
        // shows victims by responsible agency
